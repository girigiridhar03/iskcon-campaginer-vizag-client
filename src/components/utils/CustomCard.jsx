...
const CustomCard = () => {
  ...
  return (
    <Card className="relative flex flex-col overflow-hidden rounded-xl bg-card shadow-lg hover:shadow-xl transition py-3">
      {/* ================= HEADER ================= */}
      <div className="relative h-80 bg-secondary flex items-end justify-center">
        {/* Rank Pill */}
        <div className="absolute top-0 left-6 h-16 w-12 rounded-bl-lg rounded-br-lg bg-primary/90 flex items-center justify-center shadow-md">
          <span className="text-primary-foreground text-xl font-bold">1</span>
        </div>

        {/* Badge */}
        <div
          className="absolute top-3 right-4 rounded-full bg-primary px-4 py-1.5 
  ...
  animate-soft-bounce"
        ...
        {/* Bottom fade */}
        <div className="absolute bottom-0 h-20 w-full bg-gradient-to-t from-card to-transparent" />
      </div>

      {/* ================= CONTENT ================= */}
      <CardContent className="flex-1 px-6 py-1 space-y-4">
      ...
      {/* ================= FOOTER ================= */}
      <CardFooter className="relative px-6 py-2 border-t border-border overflow-hidden">
        {/* VISIBLE, PREMIUM GRADIENT */}
        <div className="absolute inset-0 bg-gradient-to-b from-primary/10 via-muted/70 to-muted" />
